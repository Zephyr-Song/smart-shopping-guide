...
export const STORES: Store[] = [
  ...
  { id: 's014', name: 'OUTCICS', category: '潮流品牌', floor: 'S-L2', x: 26, y: 46, description: '小众设计师集合', tags: ['小众', '设计师'], rating: 4.3, avgPrice: 1800, visitorCount: 400, conversionRate: 0.18, heatmap: 0.48 },
  { id: 's015', name: 'ON/OFF', category: '潮流品牌', floor: 'S-L2', x: 42, y: 46, description: '先锋买手店', tags: ['先锋', '买手'], rating: 4.4, avgPrice: 2200, visitorCount: 480, conversionRate: 0.15, heatmap: 0.52 },
  ...
  { id: 's017', name: 'PIU', category: '潮流品牌', floor: 'S-L2', x: 72, y: 46, description: '韩系潮流集合店', tags: ['韩系', '潮流'], rating: 4.2, avgPrice: 800, visitorCount: 750, conversionRate: 0.28, heatmap: 0.65 },
  { id: 's018', name: 'gudgood', category: '潮流品牌', floor: 'S-L2', x: 88, y: 46, description: '生活方式买手店', tags: ['生活', '买手'], rating: 4.3, avgPrice: 600, visitorCount: 650, conversionRate: 0.30, heatmap: 0.60 },
  // 1F - 国际精品 + 奢侈品 + 咖啡（最密集区，约19家分两行）
  { id: 's019', name: 'Alexander Wang', category: '国际精品', floor: 'S-L1', x: 5, y: 56, description: '纽约先锋潮流品牌', tags: ['设计师', '先锋'], rating: 4.5, avgPrice: 4500, visitorCount: 850, conversionRate: 0.14, heatmap: 0.68 },
  { id: 's020', name: 'I.T', category: '潮流品牌', floor: 'S-L1', x: 17, y: 56, description: '香港潮流集合店', tags: ['潮流', '集合'], rating: 4.4, avgPrice: 2500, visitorCount: 1200, conversionRate: 0.20, heatmap: 0.72 },
  { id: 's021', name: 'NEITH', category: '潮流品牌', floor: 'S-L1', x: 27, y: 56, description: '独立潮流品牌', tags: ['独立', '设计师'], rating: 4.3, avgPrice: 1800, visitorCount: 500, conversionRate: 0.16, heatmap: 0.55 },
  { id: 's022', name: 'Paul Smith', category: '国际精品', floor: 'S-L1', x: 37, y: 56, description: '英国潮流品牌', tags: ['英伦', '设计师'], rating: 4.5, avgPrice: 3200, visitorCount: 700, conversionRate: 0.18, heatmap: 0.62 },
  ...
  { id: 's032', name: 'Knatify', category: '潮流品牌', floor: 'S-L1', x: 53, y: 64, description: '新锐潮流品牌集合', tags: ['新锐', '设计师'], rating: 4.2, avgPrice: 1200, visitorCount: 350, conversionRate: 0.18, heatmap: 0.45 },
  ...
  { id: 'n015', name: 'NUMATA·SOU 沼田双', category: '潮流品牌', floor: 'N-L1-1F', x: 82, y: 68, description: '日系买手集合店', tags: ['日系', '买手'], rating: 4.3, avgPrice: 1500, visitorCount: 450, conversionRate: 0.18, heatmap: 0.48 },
  // B1 - 餐饮/宠物/便利
...
export const CATEGORIES = [
  ...
  { id: 'curated-fashion', name: '潮流品牌', icon: '🎯', color: '#6366f1' },
...
export function generateRecommendations(profile: UserProfile): Recommendation[] {
  const personaBoost: Record<string, string[]> = {
    ...
    '艺术家/设计师': ['潮流品牌', '文创杂货', '国际精品', '生活方式', '珠宝配饰', '咖啡茶饮'],
    '高收入家庭': ['精致餐饮', '品质中餐', '宠物服务', '运动健身', '生活方式', '汽车体验'],
    '本国外国游客': ['文创杂货', '珠宝配饰', '品质中餐', '咖啡茶饮', '精致餐饮', '潮流品牌'],
    '年轻潮人': ['潮流品牌', '网红餐饮', '运动时尚', '咖啡茶饮', '科技数码', '文创杂货'],
    'Z世代/网红': ['网红餐饮', '运动时尚', '咖啡茶饮', '潮流品牌', '文创杂货', '生活方式'],
    '其他': ['精致餐饮', '咖啡茶饮', '生活方式', '潮流品牌', '运动健身', '文创杂货'],
  }

  const priorityBoost: Record<string, string[]> = {
    '品质美食': ['精致餐饮', '品质中餐', '网红餐饮', '快餐轻食', '咖啡茶饮', '茶馆SPA'],
    '潮流购物': ['国际精品', '潮流品牌', '珠宝配饰', '运动时尚', '文创杂货', '科技数码'],
    '休闲娱乐': ['茶馆SPA', '运动健身', '汽车体验', '生活方式', '美容美发', '咖啡茶饮'],
    '社交打卡': ['网红餐饮', '咖啡茶饮', '潮流品牌', '文创杂货', '宠物服务', '生活方式'],
  }
