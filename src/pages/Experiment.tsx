              ...
              <div className="bg-white rounded-xl border border-gray-100 p-5">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  {activeTest.id === 'ab1'
                    ...
                    : activeTest.id === 'ab2'
                    ? '本实验正在验证基于BFC四大客群画像的定向推荐 vs 通用推荐的效果差异。预期客群定向推荐在高净值人群与HNI客群中效果更显著，将为AI精准营销系统选择最优推荐算法提供数据支撑。'
                    : '本实验验证营销活动AI智能推送的效果——根据客群画像匹配全年活动推送（如向都市家庭推送亲子活动、向潮人推送音乐节）vs 统一推送。结果将指导BFC全年营销日历的AI自动化触达策略。'}
                </p>
              </div>
            </div>
          ) : (
