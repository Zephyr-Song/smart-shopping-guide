...
const SOUTH_FLOORS: FloorInfo[] = [
  ...
  { id: 'S-L2', label: '2F', desc: '设计师买手·运动时尚', icon: <Sparkles className="w-3 h-3" /> },
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="flex-1 bg-white rounded-xl border border-gray-100 p-4">
          ...
          <div className="mt-3 text-xs text-gray-500 text-center">
            ...
            {zone === 'south' && currentFloorId === 'S-L2' && '2F 设计师买手 / 运动时尚 · ON/OFF、J.Lindeberg、OUTCICS、PIU'}
            ...
            <div className="text-xs text-gray-500 space-y-1.5">
              {zone === 'south' && (
                <>
                  ...
                  {currentFloorId === 'S-L2' && <p>南区2F，设计师买手与运动时尚，ON/OFF先锋买手店、J.Lindeberg北欧运动、OUTCICS小众设计师集合</p>}
